...
import { A as Au, g as xu } from './headless.esm-fb41148c.js';
import { I as InitializeBindings, B as BindStateToController, a as BindStateToI18n } from './initialization-utils-bdb93b26.js';
...
const AtomicPager = class {
  ...
  initialize() {
    this.searchStatus = Au(this.bindings.engine);
    this.pager = xu(this.bindings.engine, {
