import { r as registerInstance, e as getAssetPath, h, g as getElement } from './index-3acbf9e0.js';
import { o as od, i as bd, k as Id, Q as Qi, m as ec, n as df, M as Ml } from './headless.esm-fb41148c.js';
...
const AtomicSearchInterface = class {
  ...
  async executeFirstSearch() {
    ...
    this.engine.dispatch(bd.executeSearch(Id.logInterfaceLoad()));
  }
  initEngine(options) {
    try {
      this.engine = new Qi({
  ...
  initSearchParameterManager() {
    if (this.reflectStateInUrl) {
      ...
      const { serialize, deserialize } = df();
