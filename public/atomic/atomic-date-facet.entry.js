...
import { X as Xc } from './headless.esm-6bb95796.js';
import { I as Initialization } from './initialization-utils-bcbcd4a6.js';

const atomicDateFacetCss = ":host{display:block}";
...
const AtomicDateFacet = class {
  ...
  initialize() {
    ...
    this.facet = Xc(this.engine, { options });
...
__decorate([
  Initialization()
], AtomicDateFacet.prototype, "initialize", null);
